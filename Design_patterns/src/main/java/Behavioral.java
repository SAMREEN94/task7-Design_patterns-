	...
	public abstract class SortingAlgorithm {
		...
		public class Soldier {
		 ...
		 public static void main(String[] args) {
		      ...
		      Behavioral p1=new Behavioral();
		          Soldier s11 = p1.new Soldier(p1.new DefensiveMode(), "pokemon");
		          Soldier s21 = p1.new Soldier(p1.new AggresiveMode(), "aladin");
		          Soldier s3 = p1.new Soldier(p1.new DefensiveMode(), "power_ranges");
		          s11.stance();
		          s21.stance();
		          s3.stance();
		       }
